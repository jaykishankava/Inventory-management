...
function InventoryForm({ onAddItem, itemToEdit, onUpdateItem }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-3 border p-3 bg-secondary rounded">
      ...
      <button type="submit" className="btn btn-primary mt-3">{itemToEdit ? 'Update Item' : 'Add Item'}</button>
    </form>
  );
}
